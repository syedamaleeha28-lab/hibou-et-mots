...
describe("static sitemap entries", () => {
  it("includes home and hub routes", () => {
    ...
    expect(locs.some((loc) => loc.includes("/mot-du-jour/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/mots-croises-force-1/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/mots-croises-force-2/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/mots-croises-force-3/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/mots-croises-force-4/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/mots-croises-force-5/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/sudoku/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("sudoku-a-imprimer"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/sudoku-ce1/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/sudoku-ce2/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/sudoku-cm1/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("/sudoku-cm2/"))).toBe(true)
    ...
    expect(locs.some((loc) => loc.includes("/coloriage-magique-ce2/"))).toBe(true)
    expect(locs.some((loc) => loc.includes("coloriage-magique-ce2-a-imprimer"))).toBe(true)
