...
export const PHASE1_INTROS: Record<string, string> = {
  ...
  enfants:
    "Conçues spécialement pour les enfants de 3 à 12 ans, ces grilles de mots mêlés associent plaisir du jeu et vocabulaire scolaire. Les plus jeunes commencent avec des grilles 6×6 en grandes lettres (Cycle 1) ; la difficulté progresse ensuite jusqu'au CM2 (Cycle 3) avec des mots plus longs, des diagonales et un lexique de lecture courante.\n\nLes mots mêlés favorisent la concentration, la motricité fine lors du repérage visuel et la mémorisation orthographique du mot entier — un complément ludique à l'apprentissage de la lecture et à la dictée au primaire. Chaque grille peut être imprimée pour la maison ou la classe, ou jouée directement en ligne.",

  "hub-ecole":
    "Retrouvez des grilles de mots mêlés calibrées pour chaque niveau scolaire, de la maternelle au collège — du Cycle 1 au Cycle 3, dans l'esprit des repères de l'Éducation nationale. La taille de la grille, la longueur des mots et les directions de lecture évoluent avec les progrès de l'enfant : 6×6 en grandes lettres pour les tout-petits, jusqu'à 15×15 avec mots inversés pour la 6e. Chaque page de niveau propose un vocabulaire scolaire aligné sur le programme français du primaire et du début de collège.\n\nUtiliser ces grilles en classe : distribuez une fiche de vocabulaire de la semaine, proposez une activité calme en fin de séance ou croisez un thème saisonnier avec le niveau de vos élèves. Les enseignants peuvent imprimer librement les PDF avec corrigé pour corriger rapidement les copies.",
}
