...
export const THEME_ENTITY_DEFINITIONS: ThemeEntityDefinition[] = [
  ...
  },
  {
    ...
    semanticPhrases: ["mots cachés pâques", "vocabulaire de pâques", "vacances de printemps", "activité de pâques"],
  },
  {
    slug: "carnaval",
    label: "Carnaval",
    path: seasonalPath("carnaval"),
    isSeasonal: true,
    competitorEntities: [
      "déguisement",
      "masque",
    ...
    semanticPhrases: ["mots cachés carnaval", "vocabulaire de carnaval", "mardi gras", "activité de carnaval"],
  },
  {
    slug: "ete",
    label: "Été",
    path: seasonalPath("ete"),
    isSeasonal: true,
    competitorEntities: [
      "soleil",
      "plage",
    ...
    semanticPhrases: ["mots cachés été", "vocabulaire de l'été", "vacances d'été", "activité estivale"],
  },
  {
    slug: "rentree",
    label: "Rentrée",
    path: seasonalPath("rentree"),
    isSeasonal: true,
    competitorEntities: [
      "cartable",
      "cahier",
    ...
    semanticPhrases: ["mots cachés rentrée", "vocabulaire de la rentrée", "rentrée scolaire", "activité de rentrée"],
  },
  {
    slug: "printemps",
    label: "Printemps",
    path: seasonalPath("printemps"),
    isSeasonal: true,
    competitorEntities: [
      "fleurs",
      "bourgeons",
    ...
    semanticPhrases: ["mots cachés printemps", "vocabulaire du printemps", "renouveau", "activité de printemps"],
  },
  {
    slug: "pays-du-monde",
    label: "Pays du Monde",
    path: themePath("pays-du-monde"),
    isSeasonal: false,
    competitorEntities: [
      "pays",
      "capitale",
    ...
    semanticPhrases: ["mots cachés géographie", "vocabulaire de géographie", "pays et capitales", "culture générale"],
  },
  {
    slug: "sciences",
    label: "Sciences",
    path: themePath("sciences"),
    isSeasonal: false,
    competitorEntities: [
      "eau",
      "air",
    ...
    semanticPhrases: ["mots cachés sciences", "vocabulaire scientifique", "sciences du primaire", "expérience en classe"],
  },
  {
    slug: "metiers",
    label: "Métiers",
    path: themePath("metiers"),
    isSeasonal: false,
    competitorEntities: [
      "facteur",
      "pompier",
    ...
    semanticPhrases: ["mots cachés métiers", "vocabulaire des professions", "métiers et orientation", "activité sur les métiers"],
  },
  {
    slug: "animaux",
    label: "Animaux",
